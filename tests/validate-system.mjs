...
assert.match(index, /id="btnAppelClientMerci"/);
assert.match(index, /href="tel:\+22394134408"/);
assert.match(index, /Appeler Prime Service hors connexion/);
assert.match(index, /href = `tel:\+223\$\{numeroPaiementBrut\}`/);
