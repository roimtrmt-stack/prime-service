...
assert.match(geminiFunction, /parseJsonObject/);
assert.match(geminiFunction, /gemini_quota_or_rate_limit/);
assert.match(geminiFunction, /gemini_key_rejected/);
assert.match(geminiFunction, /gemini_model_unavailable/);
assert.match(geminiFunction, /gemini_request_rejected/);
