...
assert.match(imageOptimizationFunction, /detectContentBounds/);
assert.match(imageOptimizationFunction, /applyExifOrientation/);
assert.match(imageOptimizationFunction, /brightness\(0\.035\)/);
assert.match(imageOptimizationFunction, /contrast\(0\.075\)/);
assert.match(imageOptimizationFunction, /composite/);
